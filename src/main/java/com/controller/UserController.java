...
public class UserController {
    ...
    public ResponseEntity<List<UserDTO>> getAllUsers(@RequestAttribute("jwtToken") String token) {
    ...
    public ResponseEntity<UserDTO> getUserById(@PathVariable String cardCode, @RequestAttribute("jwtToken") String token) {
